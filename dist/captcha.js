...
(function () {
    ...
    class Captcha {
      constructor(element, options) {
        ...
        _this.options.id =
          "J_rotate_captcha_" + (_this.options.id || _this.index);
      ...
      render() {
        ...
        _this.$coordinate = _this.$elem.querySelectorAll(
          ".captcha-coordinate"
        )[0];
  
        _this.$control = _this.$elem.querySelectorAll(".captcha-control")[0];
        _this.$controlWrap = _this.$elem.querySelectorAll(
          ".captcha-control-wrap"
        )[0];
        _this.$controlButton = _this.$elem.querySelectorAll(
      ...
      loadImg(callback) {
        ...
        _this.getJSON(_this.options.url.create, null, function (res, xhr) {
          if (res.code === 0) {
            ...
            _this.$captchaImg.setAttribute(
              "src",
              _this.options.url.img + "?token=" + _this.token
            );
      ...
      spinImg() {
        ...
        _this.$captchaImg.style.cssText =
          "transform: rotate(" + this.runtime.deg + "deg)";
      }
      ...
      initMouse() {
        ...
        _this.$controlButton.on("mousedown", function (e) {
          if (
            ...
            _this.$controlButton.hasAttribute("animated")
          ) {
            return !1;
          }
      ...
      check() {
        ...
        _this.getJSON(
          _this.options.url.check,
          { str: _this.runtime.str, angle: _this.runtime.deg },
          function (res) {
            //res.code === 0
            if (res && res.result) {
              ...
              if (_this.options.successClose) {
                _this.timerProgressBar(
                  parseInt(_this.options.successClose) || 1500
                );
              }
            ...
            _this.$control.once("webkitAnimationEnd", function () {
              // animationend
      ...
      move(x) {
        ...
        if (x < 0) {
          ...
          x >=
          _this.$control.clientWidth - _this.$controlButton.offsetWidth
        ) {
        ...
        if (!isFail) {
          if (x < width + 1 && x > -1) {
            if (x == 0) {
              ...
              _this.$controlButton.style.cssText =
      ...
      timerProgressBar(timer) {
        ...
        let timerProgressBar =
          _this.$elem.querySelectorAll(".captcha-timer-progress-bar")[0] || null;
      ...
      captchaHTML(options) {
        return `<div id="${options.id}" class="captcha-root" style="--theme: ${
          options.theme
        };--progress-bar-color: ${
          options.timerProgressBarColor
        };--size-width: 305px;--size-img: 152px;--size-img-margin: 28px;--size-control: 275px;">
                  <div class="captcha-wrap">
                      <div class="captcha" style="--size-width: ${
                        options.width
                      }px">
                      ...
                      ${options.desc ? `<p>${options.desc}</p>` : ""}
                          ...
                          <div class="captcha-main">
                              <div class="captcha-wrap">
                                  <div class="captcha-image" style="--size-img-margin: ${
                                    options.size.imgMargin
                                  }px">
                                      <div class="captcha-img captcha-loading" style="--size-img: ${
                                        options.size.img
                                      }px">
                                              ...
                                              <svg xmlns="https://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38">
                                                  <defs>
                                                      <linearGradient x1="8.042%" y1="0%" x2="65.682%" y2="23.865%" id="a">
                                                          ...
                                                          <stop stop-color="${
                                                            options.theme
                                                          }" stop-opacity=".631" offset="63.146%"/>
                                                          <stop stop-color="${
                                                            options.theme
                                                          }" offset="100%"/>
                                                      </linearGradient>
                              ...
                              <div class="captcha-control" style="--size-control: ${
                                options.size.control
                              }px">
